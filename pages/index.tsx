		...
		>
			...
			<CoverTextInCenter
				...
				content={{
					intro: "Intro",
					head: "NexTrade",
					subHead: "Where Convenience Meets Commerce!",
				}}
				shadow={{
					opacity: 0.5,
					backgroundColor: "#000",
	...
	const slides = [
		{
			img: cliff2Img.src,
			link: "",
			caption: "Shop 'til you sparkle and let your style dazzle.",
		...
		{
			img: cliffImg.src,
			caption: "Shopping is like a box of surprises waiting to be unwrapped.",
			link: "",
